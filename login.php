...
if (isset($_POST['submit'])) {
    ...
    $password = mysqli_real_escape_string($database_connection, $password);
      ...
      $checking_query = "SELECT * FROM singup WHERE email = '$email' AND password = '$incrpassword'";
    ...
    if ($count==true) {
           $inserquery= "INSERT INTO login( email, password) VALUES ('$email','$password')";

            $run = mysqli_query($database_connection,  $inserquery);
